...
document.writeln("                                $(\'#uid\').val(obj.data.id);");
...
document.writeln("                function account(){");
document.writeln("   /*                 $.ajax(\'get\',\'http://localhost:9092/detailinit.do\',\'\',function (obj) {");
document.writeln("                        var u;");
document.writeln("                        switch(obj.code){");
document.writeln("                            case 1001:u=\'real_auth.html?username=\'+$(\'#ainfo\').html();break;");
document.writeln("                            case 1002:u=\'real_auth_auditing.html\';break;");
document.writeln("                            case 1003:u=\'real_auth_result.html\';break;");
document.writeln("                            case 1004:u=\'real_auth_error.html\';break;");
document.writeln("                        }");
document.writeln("                        location.href=u;");
document.writeln("                    })*/");
document.writeln("                    //location.href=\'real_auth.html?uid=\'+$(\'#uid\').val()+\'&username=\'+$(\'#ainfo\').html();");
document.writeln("");
document.writeln("                    $.ajax({");
document.writeln("                        type:\'get\',");
document.writeln("                        url:\'http://localhost:9092/detailinit.do\',");
document.writeln("                        date:null,");
document.writeln("                        xhrFields: {withCredentials: true},");
document.writeln("                        success:function (obj) {");
document.writeln("                            var u;");
document.writeln("                            switch(obj.code){");
...
document.writeln("                    <input type=\'hidden\' id=\'uid\'>");
